...
public class ExamenController {
	...
	/*
	@PostMapping	
	public ResponseEntity<ExamenDTO> registrar(@Valid @RequestBody ExamenDTO dtoRquest) throws Exception{
		Examen p = mapper.map(dtoRquest, Examen.class);
	...
	@PostMapping	
	public ResponseEntity<Void> registrar(@Valid @RequestBody ExamenDTO dtoRquest) throws Exception{
		Examen p = mapper.map(dtoRquest, Examen.class);
		Examen obj = service.registrar(p);
		ExamenDTO dtoResponse = mapper.map(obj, ExamenDTO.class);
	...
	@PutMapping	
	public ResponseEntity<ExamenDTO> modificar(@Valid @RequestBody ExamenDTO dtoRquest) throws Exception{
		Examen pac = service.listarPorId(dtoRquest.getIdExamen());
		if (pac == null) {
			throw new ModeloNotFoundException("ID NO ENCONTRADO" + dtoRquest.getIdExamen());
		}

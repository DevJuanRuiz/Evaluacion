...
public class PacienteController {
	...
	/*
	@PostMapping	
	public ResponseEntity<PacienteDTO> registrar(@Valid @RequestBody PacienteDTO dtoRquest) throws Exception{
		Paciente p = mapper.map(dtoRquest, Paciente.class);
	...
	@PostMapping	
	public ResponseEntity<Void> registrar(@Valid @RequestBody PacienteDTO dtoRquest) throws Exception{
		Paciente p = mapper.map(dtoRquest, Paciente.class);
		Paciente obj = service.registrar(p);
		PacienteDTO dtoResponse = mapper.map(obj, PacienteDTO.class);
	...
	@PutMapping	
	public ResponseEntity<PacienteDTO> modificar(@Valid @RequestBody PacienteDTO dtoRquest) throws Exception{
		Paciente pac = service.listarPorId(dtoRquest.getIdPaciente());
		if (pac == null) {
			throw new ModeloNotFoundException("ID NO ENCONTRADO" + dtoRquest.getIdPaciente());
		}
